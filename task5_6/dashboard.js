...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const alrt_preview = document.querySelector(".alert-preview");
    ...
    const ann_preview = document.querySelector(".announce-preview");
    ...
    const ham_contentToggle = document.querySelector(".content-toggle");
    function showMenu() {
        if (ham_menu) {
            clearTimeout(hideTimeout);
