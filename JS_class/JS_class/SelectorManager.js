...
     */
    constructor(dimensions, commandManager, renderer) {
        ...
        /**
         * @type {string|null} - The currently active selection type ('cell', 'row', 'column').
         */
        this.activeSelectionType = null; // 'cell', 'row', or 'column'
    ...
    handlePointerDown(e) {
        for(let i = 0; i < this.handler.length; i++) {
            ...
            if(h.hitTest(e)) {
                ...
                if ( h instanceof RowSelector ) {
                    this.lastActiveCell = {
                        row : h.firstSelectedRow,
                        col : 1
                    };
                    this.lastSelectionType = 'row';
                } 
                else if ( h instanceof ColumnSelector ) {
                    this.lastActiveCell = {
                        row : 1,
                        col : h.firstSelectedColumn
                    };
                    this.lastSelectionType = 'column';
                } 
                else if ( h instanceof CellSelector ){
                    this.lastActiveCell = {
                        col : h.selectionStart.col,
                        row : h.selectionStart.row
                    };
                    this.lastSelectionType = 'cell';
                }
